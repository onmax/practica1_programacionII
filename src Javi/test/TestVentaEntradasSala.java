...
/**
 * Este programa de prueba no es exhaustivo, solo ilustrativo de como se pueden
 * probar directamente los metodos de la practica. Por tanto, el alumno deberia
 * ampliar este main con el fin de asegurarse de la correccion de su codigo.
 * 
 * @author jramirez
 *
 */
...
public class TestVentaEntradasSala {
	...
	public static void main(String[] args) {
		// creamos un sala con 2 salas (con 2 sesiones) para probar las
		// operaciones
