...
public class Sesion {
	...
	public int getFilas() {
		return this.estadoAsientos.length;
	}

	public int getColumnas() {
		return this.estadoAsientos[0].length;
	}
	...
	public int getButacasDisponiblesSesion() {
		...
		// sesión.
		// OPCION 1: Para esta opción hace falta añadir <--
		// this.asientosDisponibles -= 1; --> en comprarEntrada, pero no viene
		// en el pdf.
